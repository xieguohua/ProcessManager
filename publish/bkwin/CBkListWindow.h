...
protected:
	...
	CRect			  m_rcItem; //当前内容显示区域
	BOOL			  m_bExternline;
	BOOL			  m_bShowScrollBar; // 是否显示滚动条
	BOOL			  m_bScrollByMouseWhell; //是否用鼠标滚轮进行操作内容滚动
	BOOL			  m_bScrollByMouseDragMove; // 是否用鼠标拖动进行操作内容滚动
